...
export const Testimonials = () => {
    ...
    return (
        <>
            <span className='text-3xl font-bold tinos-regular sm:text-4xl xl:text-5xl font-pj'>Testimonials</span>
            <div className="mt-6 grid grid-cols-1 gap-6 w-full md:grid-cols-4 md:grid-rows-4 md:auto-rows-fr py-6">
                {
                    testimonials.map(({ id, quote, name, position, image }) => (
                        <div className="md:col-span-2 md:row-span-2 border-b-3 border-[#8A8635] p-8 flex">
                            <div className="flex flex-col justify-between h-full gap-4">
                                <div className="relative px-6">
                                    <FaQuoteLeft className="absolute left-0 top-0 text-gray-300 text-sm" />
                                    <p className="tnios-regular text-md md:text-base md:text-lg font-medium text-gray-700 leading-relaxed line-clamp-5">
                                        {quote}
                                    </p>
