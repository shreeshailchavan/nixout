export default function Hero() {
    ...
    <section className="bg-[#FCF8F1] bg-opacity-30 py-4 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    ...
                    <a href="#" title="" className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-[#8A8635] rounded-full lg:mt-16 hover:bg-[#FCF8F1] focus:bg-bg-[#FCF8F1] hover:text-[#8A8635] hover:outline" role="button">
                        Contact Us
